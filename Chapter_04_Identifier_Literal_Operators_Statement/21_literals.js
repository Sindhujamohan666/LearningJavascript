let age="Sindhuja"; // This is a string literal assigned to the variable 'age'--Double Quote.
let  name='Sindhuja'; // This is also a string literal assigned to the variable 'name'--Single quote.
